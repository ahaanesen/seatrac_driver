...
impl CID_E {
    ...
    pub fn to_string(&self) -> &'static str {
        match *self {
            CID_E::CID_SYS_ALIVE => "CID_SYS_ALIVE",
            CID_E::CID_SYS_INFO => "CID_SYS_INFO",
            CID_E::CID_SYS_REBOOT => "CID_SYS_REBOOT",
            CID_E::CID_SYS_ENGINEERING => "CID_SYS_ENGINEERING",
            CID_E::CID_PROG_INIT => "CID_PROG_INIT",
            CID_E::CID_PROG_BLOCK => "CID_PROG_BLOCK",
            CID_E::CID_PROG_UPDATE => "CID_PROG_UPDATE",
            CID_E::CID_STATUS => "CID_STATUS",
            CID_E::CID_STATUS_CFG_GET => "CID_STATUS_CFG_GET",
            CID_E::CID_STATUS_CFG_SET => "CID_STATUS_CFG_SET",
            CID_E::CID_SETTINGS_GET => "CID_SETTINGS_GET",
            CID_E::CID_SETTINGS_SET => "CID_SETTINGS_SET",
            CID_E::CID_SETTINGS_LOAD => "CID_SETTINGS_LOAD",
            CID_E::CID_SETTINGS_SAVE => "CID_SETTINGS_SAVE",
            CID_E::CID_SETTINGS_RESET => "CID_SETTINGS_RESET",
            CID_E::CID_CAL_ACTION => "CID_CAL_ACTION",
            CID_E::CID_AHRS_CAL_GET => "CID_AHRS_CAL_GET",
            CID_E::CID_AHRS_CAL_SET => "CID_AHRS_CAL_SET",
            CID_E::CID_XCVR_ANALYSE => "CID_XCVR_ANALYSE",
            CID_E::CID_XCVR_TX_MSG => "CID_XCVR_TX_MSG",
            CID_E::CID_XCVR_RX_ERR => "CID_XCVR_RX_ERR",
            CID_E::CID_XCVR_RX_MSG => "CID_XCVR_RX_MSG",
            CID_E::CID_XCVR_RX_REQ => "CID_XCVR_RX_REQ",
            CID_E::CID_XCVR_RX_RESP => "CID_XCVR_RX_RESP",
            CID_E::CID_XCVR_RX_UNHANDLED => "CID_XCVR_RX_UNHANDLED",
            CID_E::CID_XCVR_USBL => "CID_XCVR_USBL",
            CID_E::CID_XCVR_FIX => "CID_XCVR_FIX",
            CID_E::CID_XCVR_STATUS => "CID_XCVR_STATUS",
            CID_E::CID_XCVR_TX_MSGCTRL_SET => "CID_XCVR_TX_MSGCTRL_SET",
            CID_E::CID_XCVR_USBL_TIME => "CID_XCVR_USBL_TIME",
            CID_E::CID_XCVR_BASELINE => "CID_XCVR_BASELINE",
            CID_E::CID_PING_SEND => "CID_PING_SEND",
            CID_E::CID_PING_REQ => "CID_PING_REQ",
            CID_E::CID_PING_RESP => "CID_PING_RESP",
            CID_E::CID_PING_ERROR => "CID_PING_ERROR",
            CID_E::CID_ECHO_SEND => "CID_ECHO_SEND",
            CID_E::CID_ECHO_REQ => "CID_ECHO_REQ",
            CID_E::CID_ECHO_RESP => "CID_ECHO_RESP",
            CID_E::CID_ECHO_ERROR => "CID_ECHO_ERROR",
            CID_E::CID_NAV_QUERY_SEND => "CID_NAV_QUERY_SEND",
            CID_E::CID_NAV_QUERY_REQ => "CID_NAV_QUERY_REQ",
            CID_E::CID_NAV_QUERY_RESP => "CID_NAV_QUERY_RESP",
            CID_E::CID_NAV_ERROR => "CID_NAV_ERROR",
            CID_E::CID_NAV_QUEUE_SET => "CID_NAV_QUEUE_SET",
            CID_E::CID_NAV_QUEUE_CLR => "CID_NAV_QUEUE_CLR",
            CID_E::CID_NAV_QUEUE_STATUS => "CID_NAV_QUEUE_STATUS",
            CID_E::CID_NAV_STATUS_SEND => "CID_NAV_STATUS_SEND",
            CID_E::CID_NAV_STATUS_RECEIVE => "CID_NAV_STATUS_RECEIVE",
            CID_E::CID_NAV_QUEUE_GET => "CID_NAV_QUEUE_GET",
            CID_E::CID_DAT_SEND => "CID_DAT_SEND",
            CID_E::CID_DAT_RECEIVE => "CID_DAT_RECEIVE",
            CID_E::CID_DAT_ERROR => "CID_DAT_ERROR",
            CID_E::CID_DAT_QUEUE_SET => "CID_DAT_QUEUE_SET",
            CID_E::CID_DAT_QUEUE_CLR => "CID_DAT_QUEUE_CLR",
            CID_E::CID_DAT_QUEUE_STATUS => "CID_DAT_QUEUE_STATUS",
            CID_E::CID_DAT_QUEUE_GET => "CID_DAT_QUEUE_GET",
            CID_E::CID_CFG_BEACON_GET => "CID_CFG_BEACON_GET",
            CID_E::CID_CFG_BEACON_SET => "CID_CFG_BEACON_SET",
            CID_E::CID_CFG_BEACON_RESP => "CID_CFG_BEACON_RESP",
            CID_E::CID_CFG_REQ_SEND => "CID_CFG_REQ_SEND",
            CID_E::CID_CFG_REQ_RECEIVE => "CID_CFG_REQ_RECEIVE",
            CID_E::CID_CFG_RESP_SEND => "CID_CFG_RESP_SEND",
            CID_E::CID_CFG_RESP_RECEIVE => "CID_CFG_RESP_RECEIVE",
        }
    }
}
